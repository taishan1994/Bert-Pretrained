...
from transformers import DebertaV2Model, DebertaV2ForSequenceClassification, AutoTokenizer, AutoConfig

from transformers_local import AdamW, WarmupLinearSchedule
...
MODEL_CLASSES = {
    ...
    "debertav2": (AutoConfig, DebertaV2ForSequenceClassification, AutoTokenizer)
}
...
def main():
    ...
    print("模型路径：", args.model_name_or_path)
